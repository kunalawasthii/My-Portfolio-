...
export const RESUME_DATA: ResumeData = {
  ...
  "achievements": [
    {
      ...
      "context": "Presented research paper at ICRTICC-2025, Galgotias College of Engineering and Technology",
      "type": "Publication"
    },
    {
    ...
    },
    {
      ...
      "context": "Successfully completed multiple modules covering firewall, VPN, and security policies",
      "type": "Performance"
    },
    {
  ...
  "skills": {
    "Backend & AI": ["Python", "Flask", "FastAPI", "ML libraries", "Node.js", "MongoDB", "SQL"],
    "Frontend": ["React.js", "JavaScript", "HTML5", "CSS3", "Bootstrap", "jQuery"],
    "Tools & Others": ["Git", "GitHub", "Network Security", "Firewall Configuration", "VPN Setup"]
  },
  "education": [
    {
  ...
  "certifications": [
    ...
    },
    {
      ...
      "url": "https://archive.nptel.ac.in/content/noc/NOC24/SEM2/Ecertificates/106/noc24-cs130/Course/NPTEL24CS130S45130649604106508.pdf"
    }
  ],
  "extra": []
};
